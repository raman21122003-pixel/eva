...
def offline_chat(text):
    ...
    # 3. New Capabilities
        ...
        return "I cannot check the live weather yet, but I hope it's sunny outside."
    elif "joke" in text:
    ...
    # 8. Mock Actions & Skills
        ...
        return "I am dancing metaphorically inside the server. Can you feel the rhythm?"
    elif "rap" in text:
